<?php
    ...
    if($_POST['delete']){
        if($_POST['imagem']){
            unlink("../volume/destaques/".$_POST['imagem']);
        }
        $query = "delete from destaques where codigo = '{$_POST['delete']}'";
        mysqli_query($con, $query);
      }

      if($_POST['situacao']){
        // mysqli_query($con, "update destaques set situacao = '0'");
        $query = "update destaques set situacao = '{$_POST['opc']}' where codigo = '{$_POST['situacao']}'";
        mysqli_query($con, $query);
        exit();
      }
        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <table class="table table-striped table-hover">
              ...
              <tbody>
                <?php
                  $query = "select * from destaques order by titulo asc";
