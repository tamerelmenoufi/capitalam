    ...
    if(!$_SESSION['wapp']){
    ?>
    <!-- <div style="position:fixed; bottom:205px; right:20px; width:200px; border:solid 0px red; z-index:999">
        <a href="https://wa.me/5592981490062?text=Olá, gostaria de ajuda para antecipar o meu FGTS" target="_blank" class="btn btn-success btn-lg">Fale Conosco <i class="fa-brands fa-whatsapp"></i></a>
    </div> -->
    <?php
    }
    ?>
